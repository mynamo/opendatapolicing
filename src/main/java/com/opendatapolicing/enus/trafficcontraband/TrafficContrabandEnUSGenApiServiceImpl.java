...
public class TrafficContrabandEnUSGenApiServiceImpl implements TrafficContrabandEnUSGenApiService {
						...
						putcopyTrafficContrabandResponse(siteRequest, c -> {
							if(c.succeeded()) {
								...
								workerExecutor.executeBlocking(
									blockingCodeHandler -> {
										try {
											aSearchTrafficContraband(siteRequest, false, true, "/api/contraband/copy", "PUTCopy", d -> {
												if(d.succeeded()) {
						...
						futures.add(Future.future(a -> {
							...
							-> {
								if(b.succeeded())
									...
									a.handle(Future.failedFuture(new Exception("value TrafficContraband.stopAgencyTitle failed", b.cause())));
							});
						}));
						break;
					case "stopDateTime":
						futures.add(Future.future(a -> {
							...
							-> {
								if(b.succeeded())
									...
									a.handle(Future.failedFuture(new Exception("value TrafficContraband.stopDateTime failed", b.cause())));
							});
						}));
						break;
					case "stopPurposeNum":
						futures.add(Future.future(a -> {
							...
							-> {
								if(b.succeeded())
									...
									a.handle(Future.failedFuture(new Exception("value TrafficContraband.stopPurposeNum failed", b.cause())));
							});
						}));
						break;
						...
						futures.add(Future.future(a -> {
							...
							-> {
								if(b.succeeded())
									...
									a.handle(Future.failedFuture(new Exception("value TrafficContraband.stopPurposeTitle failed", b.cause())));
							});
						}));
						break;
					case "stopActionNum":
						futures.add(Future.future(a -> {
							...
							-> {
								if(b.succeeded())
									...
									a.handle(Future.failedFuture(new Exception("value TrafficContraband.stopActionNum failed", b.cause())));
							});
						}));
						break;
						...
						futures.add(Future.future(a -> {
							...
							-> {
								if(b.succeeded())
									...
									a.handle(Future.failedFuture(new Exception("value TrafficContraband.stopActionTitle failed", b.cause())));
							});
						}));
						break;
						...
						futures.add(Future.future(a -> {
							...
							-> {
								if(b.succeeded())
									...
									a.handle(Future.failedFuture(new Exception("value TrafficContraband.stopDriverArrest failed", b.cause())));
							});
						}));
						break;
						...
						futures.add(Future.future(a -> {
							...
							-> {
								if(b.succeeded())
									...
									a.handle(Future.failedFuture(new Exception("value TrafficContraband.stopPassengerArrest failed", b.cause())));
							});
						}));
						break;
						...
						futures.add(Future.future(a -> {
							...
							-> {
								if(b.succeeded())
									...
									a.handle(Future.failedFuture(new Exception("value TrafficContraband.stopEncounterForce failed", b.cause())));
							});
						}));
						break;
						...
						futures.add(Future.future(a -> {
							...
							-> {
								if(b.succeeded())
									...
									a.handle(Future.failedFuture(new Exception("value TrafficContraband.stopEngageForce failed", b.cause())));
							});
						}));
						break;
						...
						futures.add(Future.future(a -> {
							...
							-> {
								if(b.succeeded())
									...
									a.handle(Future.failedFuture(new Exception("value TrafficContraband.stopOfficerInjury failed", b.cause())));
							});
						}));
						break;
						...
						futures.add(Future.future(a -> {
							...
							-> {
								if(b.succeeded())
									...
									a.handle(Future.failedFuture(new Exception("value TrafficContraband.stopDriverInjury failed", b.cause())));
							});
						}));
						break;
						...
						futures.add(Future.future(a -> {
							...
							-> {
								if(b.succeeded())
									...
									a.handle(Future.failedFuture(new Exception("value TrafficContraband.stopPassengerInjury failed", b.cause())));
							});
						}));
						break;
					case "stopOfficerId":
						futures.add(Future.future(a -> {
							...
							-> {
								if(b.succeeded())
									...
									a.handle(Future.failedFuture(new Exception("value TrafficContraband.stopOfficerId failed", b.cause())));
							});
						}));
						break;
					case "stopLocationId":
						futures.add(Future.future(a -> {
							...
							-> {
								if(b.succeeded())
									...
									a.handle(Future.failedFuture(new Exception("value TrafficContraband.stopLocationId failed", b.cause())));
							});
						}));
						break;
					case "stopCityId":
						futures.add(Future.future(a -> {
							...
							-> {
								if(b.succeeded())
									...
									a.handle(Future.failedFuture(new Exception("value TrafficContraband.stopCityId failed", b.cause())));
							});
						}));
						break;
					case "personTypeId":
						futures.add(Future.future(a -> {
							...
							-> {
								if(b.succeeded())
									...
									a.handle(Future.failedFuture(new Exception("value TrafficContraband.personTypeId failed", b.cause())));
							});
						}));
						break;
					case "personGenderId":
						futures.add(Future.future(a -> {
							...
							-> {
								if(b.succeeded())
									...
									a.handle(Future.failedFuture(new Exception("value TrafficContraband.personGenderId failed", b.cause())));
							});
						}));
						break;
						...
						futures.add(Future.future(a -> {
							...
							-> {
								if(b.succeeded())
									...
									a.handle(Future.failedFuture(new Exception("value TrafficContraband.personEthnicityId failed", b.cause())));
							});
						}));
						break;
					case "personRaceId":
						futures.add(Future.future(a -> {
							...
							-> {
								if(b.succeeded())
									...
									a.handle(Future.failedFuture(new Exception("value TrafficContraband.personRaceId failed", b.cause())));
							});
						}));
						break;
					case "searchTypeNum":
						futures.add(Future.future(a -> {
							...
							-> {
								if(b.succeeded())
									...
									a.handle(Future.failedFuture(new Exception("value TrafficContraband.searchTypeNum failed", b.cause())));
							});
						}));
						break;
						...
						patchTrafficContrabandResponse(siteRequest, c -> {
							if(c.succeeded()) {
								...
								workerExecutor.executeBlocking(
									blockingCodeHandler -> {
										try {
											aSearchTrafficContraband(siteRequest, false, true, "/api/contraband", "PATCH", d -> {
												if(d.succeeded()) {
													SearchList<TrafficContraband> listTrafficContraband = d.result();
													ApiRequest apiRequest = new ApiRequest();
													apiRequest.setRows(listTrafficContraband.getRows());
		...
		try {
			{
				userTrafficContraband(siteRequest, b -> {
					if(b.succeeded()) {
						aSearchTrafficContraband(siteRequest, false, true, "/api/contraband/{id}", "GET", c -> {
							if(c.succeeded()) {
		...
		try {
			{
				userTrafficContraband(siteRequest, b -> {
					if(b.succeeded()) {
						aSearchTrafficContraband(siteRequest, false, true, "/api/contraband", "Search", c -> {
							if(c.succeeded()) {
								SearchList<TrafficContraband> listTrafficContraband = c.result();
		...
		try {
			{
				userTrafficContraband(siteRequest, b -> {
					if(b.succeeded()) {
						aSearchTrafficContraband(siteRequest, false, true, "/api/admin/contraband", "AdminSearch", c -> {
							if(c.succeeded()) {
								SearchList<TrafficContraband> listTrafficContraband = c.result();
		...
		try {
			{
				userTrafficContraband(siteRequest, b -> {
					if(b.succeeded()) {
						aSearchTrafficContraband(siteRequest, false, true, "/contraband", "SearchPage", c -> {
							if(c.succeeded()) {
								SearchList<TrafficContraband> listTrafficContraband = c.result();
	...
	public void aSearchTrafficContraband(SiteRequestEnUS siteRequest, Boolean populate, Boolean store, String uri, String apiMethod, Handler<AsyncResult<SearchList<TrafficContraband>>> eventHandler) {
		try {
			OperationRequest operationRequest = siteRequest.getOperationRequest();
